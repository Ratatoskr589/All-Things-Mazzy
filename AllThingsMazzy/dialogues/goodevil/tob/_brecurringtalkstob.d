...
CHAIN IF WEIGHT #-1 ~InParty("Mazzy") !StateCheck("Mazzy",CD_STATE_NOTVALID) Global("_BMazzyFriendship","GLOBAL",1) Global("_bMazzyTalk","GLOBAL",2)~ THEN MAZZY25J _bRecurringTalkMaster
...
END
	...
	+ ~Global("_bMazzyInterestTOB","GLOBAL",1)~ + @1450 /*Mazzy, I have decided that I wish to be your lover after all.*/ + _bMazNoCourt
	...
	+ ~Global("_bPostWraithQuestions","GLOBAL",1)~ + @816 /*You said you went to war when you were young. Why?*/ + _bMazzyWraithTalks
	+ ~Global("_bPostWraithQuestions","GLOBAL",2)~ + @826 /*You said your army attacked a nearby city. What happened afterwards?*/ + _bMazzyWraithTalks2
	+ ~Global("_bPostWraithQuestions","GLOBAL",3)~ + @844 /*Do you want to talk about your father? How did he die?*/ + _bMazzyWraithTalks3
	+ ~Global("_bPostWraithQuestions","GLOBAL",4)~ + @854 /*How did you return home after your time in the army?*/ + _bMazzyWraithTalks4 
	+ ~Global("_bMazzyHalfOgres","GLOBAL",1)~ + @364 /*You were going to tell me a story about you and some half-ogres...*/ GOTO _bMazHalfOgreStory
...
CHAIN MAZZY25J _bMazzypaladin2
...
APPEND MAZZY25J IF ~~ THEN  _bMazzypaladin1
...
APPEND MAZZY25J IF ~~ THEN _bMazzyTradeM2
...
CHAIN MAZZY25J _bMazzyTooTired
...
APPEND MAZZY25J IF ~~ THEN _bMazzyFuture1
...
CHAIN MAZZY25J _bMazzyForgives
...
CHAIN MAZZY25J _bMazzyFaithful
...
CHAIN MAZZY25J _bMazYesSex
@141 /*I do not wish to make you uncomfortable, <CHARNAME>, but if you are truly willing, I would be glad to spend a night with you.*/
= @135 /*But first we must bathe so let us find an inn. We are both covered in dirt, filth, and blood and I would prefer to be at least somewhat clean before we know each other intimately.*/
...
DO ~SetGlobal("_bMazzyInterest","GLOBAL",2) SetGlobal("_bMazzyInterestTOB","GLOBAL",2)~
END


CHAIN MAZZY25J _bMazSexTalk
...
CHAIN MAZZY25J _bMazFemChoices
...
APPEND MAZZY25J IF ~~ THEN _bMazFemLickYou
...
APPEND MAZZY25J IF ~~ THEN _bMazFFM3
	...
	+ ~IfValidForPartyDialogue("Sarevok") Global("_bCNChoosesSarev3","GLOBAL",0)~ + @1850 /*Sarevok.*/ + _bMazSarev3SomeNo 
	...
	+ ~IfValidForPartyDialogue("Anomen") Global("_bCNChoosesAnomen3","GLOBAL",0) Global("AnomenIsKnight","GLOBAL",1) Global("_bCNWantsAno3Some","GLOBAL",0) Global("AnomenIsKnight","GLOBAL",1)~ + @192 /*Anomen.*/ + _bAno3SomeYes
	+ ~IfValidForPartyDialogue("Anomen") Global("AnomenIsKnight","GLOBAL",1) Global("_bCNChoosesAnomen3","GLOBAL",1)~ + @1920 /*I would like Anomen again.*/ + _bAno3SomeAgain
	+ ~IfValidForPartyDialogue("Anomen") Global("AnomenIsKnight","GLOBAL",1) Global("_bCNChoosesAnomen3","GLOBAL",0) Global("_bCNWantsAno3Some","GLOBAL",1)~ + @193 /*I already told you that I wanted Anomen.*/ + _bAno3SomeDuh
	...
	IF ~~ THEN _bMazSarev3SomeNo
	SAY @1990 /*No. That is such a ridiculous suggestion that I refuse to even list my reasons for refusal.*/
	IF ~~ THEN DO ~SetGlobal("_bCNChoosesSarev3","GLOBAL",1)~ + _bMazNewChoice
	END
	...
	IF ~Global("AnomenRomanceActive","GLOBAL",2)~ THEN EXTERN ANOME25J _bAno3SomeFFMHeckYes
	IF ~Gender(Player1,FEMALE) !Global("AnomenRomanceActive","GLOBAL",2)~ THEN EXTERN ANOME25J _bAno3SomeFFMYes
	IF ~Gender(Player1,MALE) !Global("AnomenRomanceActive","GLOBAL",2)~ THEN EXTERN ANOME25J _bAno3SomeFMMYes
	END
	...
	IF ~~ THEN _bJan3Some1
	SAY @233 /*Very well, but only if he does what we say and you lie with him first. I will reserve judgment until then.*/
	...
	IF ~InPartyAllowDead("Aerie") !Global("_bHDDORNROMANCE","GLOBAL",2) !Global("LS_HaerDalisRomanceActive","GLOBAL",2) Global("HaerDalisRomanceActive","GLOBAL",2)~ THEN EXTERN HAERD25J  _bHD3SomeNo
	IF ~!Global("_bHDDORNROMANCE","GLOBAL",2) OR(3) !InPartyAllowDead("Aerie") Global("LS_HaerDalisRomanceActive","GLOBAL",2) !Global("HaerDalisRomanceActive","GLOBAL",2)~ THEN EXTERN HAERD25J  _bHD3SomeYes
	IF ~IfValidForPartyDialog("Dorn") Global("_bHDDORNROMANCE","GLOBAL",2)~ THEN EXTERN HAERD25J  _bHD3SomeDorn
	IF ~!IfValidForPartyDialog("Dorn") Global("_bHDDORNROMANCE","GLOBAL",2)~ THEN EXTERN HAERD25J  _bHD3SomeDornAsk
END
	...
	IF ~~ THEN EXTERN VALYG25J _bValg3SomeYes
	END
...
CHAIN MAZZY25J _bAno3SomeAgain
...
== ANOME25J @228 /*Of course, my lady. A knight must always serve when needed.*/
...
APPEND ANOME25J IF ~~ THEN _bAno3SomeFFMHeckYes
...
CHAIN MAZZY25J _bJan3Some2
@236 /*Jan! A word.*/
== JAN25J @237 /*You must be thinking of someone else, Mazzy. When have I been known to say only one word, when there are so many words to choose from? In fact this reminds me of the time...*/
== MAZZY25J @238 /*No. Be silent and listen. Jan, <CHARNAME> wants you to join us tonight, sexually, and I have acquiesced.*/
...
== JAN25J @241 /*Well, Mazzy, that is the most you've said to me since we started traveling together. If you keep this up, you will become more loquacious than my second-cousin. She was never given a name at birth and made up for it by...*/
== MAZZY25J @242 /*You are already making me regret this. I have stated our proposition and I require an answer!*/
== JAN25J @243 /*Yes.*/
== MAZZY25J @244 /*Just, “yes”? No, “Yes, and I have a story...” or, “Wow that reminds me of the time...”, or some story about turnips?!*/
== JAN25J IF ~Gender(Player1,FEMALE)~ THEN @245 /*Two beautiful lasses just asked me to join them for a night. Is there really anything else that needs to be said?*/
== JAN25J IF ~Gender(Player1,MALE)~ THEN @246 /*A beautiful lass and a handsome lad just asked me to join them for a night. Is there really anything else that needs to be said?*/
== MAZZY25J @247 /*I suppose not. Let us get this over with.*/
...
CHAIN MAZZY25J _bJan3SomeAgain
...
== DORN25J @2621 /*What is the meaning of this, tiefling? I knew you were a fickle creature, but this is a step too far!*/
== HAERD25J @2622 /*Your fury is misaimed, my vulture... and rather baffling. Did you not wish to lay with <CHARNAME>? Only a blind man or a fool would invite one of us without the other and you have often expressed your admiration for our brave leader's form.*/
== DORN25J IF ~Global("DornRomanceActive","GLOBAL",3)~ THEN @2624 /*<CHARNAME> had <PRO_HISHER> chance already. I will not go crawling back.*/
== DORN25J IF ~!Global("DornRomanceActive","GLOBAL",3)~ THEN @2625 /*If it were <CHARNAME> alone, that might be acceptable.*/
== MAZZY25J @2626 /*I will not sleep with the blackguard! I would sooner stab myself with my own blade!*/
== DORN25J @2627 /*The disgust is mutual, halfling.*/ 
DO ~SetGlobal("_bDornSaidUggh","GLOBAL",1)~
== HAERD25J  @2628 /*Ah...  it seems this bard misjudged the situation. I apologize, <CHARNAME>, but you shall have to seek your pleasure without this sparrow at your side.*/
EXIT

CHAIN HAERD25J _bHD3SomeDornAsk
@2629  /*This sparrow is quite tempted but must decline the invitation. My grim vulture is most possessive and so my wings must stay within this nest while he cannot join in.*/
DO ~SetGlobal("_bNotWODorn","GLOBAL",1)~
= @2630 /*Perhaps you might ask again another time.*/
EXIT

CHAIN HAERD25J _bHD3SomeYes
...
== MAZZY25J @266 /*You will be devoured alive. Are you in or not?*/
== HAERD25J @267 /*This sparrow is not yet in, but I hope to be soon. And if I should die this day, I will look back on my end and I will exclaim...*/
= @268 /*..."It was a fitting death to a life lived well."*/
== HAERD25J  IF ~Global("LS_HaerDalisRomanceActive","GLOBAL",2)~ THEN @265 /*The raven alone has proved to be consuming in our physical delights. The three of us will burn with ecstasy as sharp as the blades I carry at my side.*/
== MAZZY25J @269 /*<CHARNAME>, I cannot believe what we are about to get ourselves into, but let's do it. He is who-knows-how-old; maybe he's picked up a few tricks along the way.*/
DO ~SetGlobal("_bCNChoosesHD3","GLOBAL",1) RestParty()~
EXIT

CHAIN IF WEIGHT #-1 ~Global("_bHDAwesome","GLOBAL",1) !Global("LS_HaerDalisRomanceActive","GLOBAL",2)~ THEN MAZZY25J _bHDApology
...
== HAERD25J @271 /*This sparrow cannot be caged, my hawk, or its beak would droop and its colors dull. But if you call, I will come.*/
DO ~SetGlobal("_bHDAwesome","GLOBAL",2)~ 
EXIT

CHAIN IF WEIGHT #-1 ~Global("_bHDAwesome","GLOBAL",1) Global("LS_HaerDalisRomanceActive","GLOBAL",2)~ THEN MAZZY25J _bHDApology2
...
== HAERD25J @273 /*This sparrow sings most sweetly with my raven but I am glad to hear my efforts did not disappoint. I would be pleased to share such delightful tricks from across the planes again another time. Once my plumage has recovered from such sweet devouring, simply call and I will come.*/
DO ~SetGlobal("_bHDAwesome","GLOBAL",2)~ 
EXIT

APPEND MAZZY25J IF ~~ THEN _bHD3SomeAgain
SAY @274 /*A good choice. Where has that mad bard gone?*/
= @275 /*Haer'Dalis, <CHARNAMAE> and I require your services again.*/
	IF ~InPartyAllowDead("Aerie") !Global("LS_HaerDalisRomanceActive","GLOBAL",2) Global("HaerDalisRomanceActive","GLOBAL",2) !Global("_bHDDORNROMANCE","GLOBAL",2)~ THEN EXTERN HAERD25J  _bHD3SomeNo
	IF ~!Global("_bHDDORNROMANCE","GLOBAL",2) OR(3) !InPartyAllowDead("Aerie") Global("LS_HaerDalisRomanceActive","GLOBAL",2) !Global("HaerDalisRomanceActive","GLOBAL",2)~ THEN EXTERN HAERD25J _bHD3SomeAgainYes
	IF ~IfValidForPartyDialog("Dorn") Global("_bHDDORNROMANCE","GLOBAL",2)~ THEN EXTERN HAERD25J  _bHD3SomeDorn
	IF ~!IfValidForPartyDialog("Dorn") Global("_bHDDORNROMANCE","GLOBAL",2)~ THEN EXTERN HAERD25J  _bHD3SomeDornAsk
END 
END 

CHAIN HAERD25J _bHD3SomeAgainYes
@276 /*Of course, my hawk. As promised, this sparrow will answer your sweet call.*/
DO ~RestParty() ApplySpellRES("_BTIRED","HaerDalis")~
EXIT

CHAIN VALYG25J _bValg3SomeYes
@279 /*Is sleeping with their knight one of the jobs of a squire? I haven't heard of this before.*/
== MAZZY25J IF ~Gender(Player1,FEMALE)~ THEN @280 /*Well, most knights and squires are men, Valygar, though you might be surprised how rarely that stops them. We, however, are two attractive women, and while we are enjoying each other's company tremendously, we have been thinking that you would make an exciting addition.*/
== MAZZY25J IF ~Gender(Player1,MALE)~ THEN @281 /*Although most knights and squires are men, you might be surprised how rarely that stops them. And if you truly are not interested, we need speak no more of this. However, while <CHARNAME> and I have been enjoying each other's company tremendously, we believe that you would make an exciting addition to our bed.*/
== MAZZY25J @282 /*If you perform your duties well, it may even become a regular occurrence.*/
== VALYG25J IF ~Gender(Player1,FEMALE)~ THEN @283 /*As my ladies command.*/
== VALYG25J IF ~Gender(Player1,MALE)~ THEN @284 /*You need not fear my sensibilities. I am more interested in a person than the trappings that they wear.*/
== VALYG25J @285 /*I would be honored to join you both this <DAYNIGHTALL>.*/
...
CHAIN MAZZY25J _bValg3SomeAgain
@286 /*As do I.*/
== VALYG25J @287 /*It is a good thing I am here then.*/
== MAZZY25J @288 /*It really is ungentlemanly to sneak up on us like that.*/
== VALYG25J @289 /*My apologies, mistress.*/
== MAZZY25J @290 /*I am only joking. Your ability to slip in and out unnoticed is one of your many fine attributes. You are everything a knight could want.*/
...
APPEND MAZZY25J IF ~~ THEN _bMazFFF3
	...
	+ ~Global("_bCNWantsVic3Some","GLOBAL",1) Global("_bMazzyVicFriends","GLOBAL",2) IfValidForPartyDialogue("Viconia") Global("_bVicMaz3Some","GLOBAL",0)~ + @299 /*I want Viconia. I already told you that.*/ + _bMazFFFVic
	...
	+ ~Global("ImoenRomanceActive","GLOBAL",2) IfValidForPartyDialogue("Imoen2") Global("_bCNChoosesIm3","GLOBAL",0) OR(2) Global("_bImoenMazzyRomance","GLOBAL",0) Global("_bImoenMazzyRomance","GLOBAL",3)~ + @308 /*Imoen.*/ + _bMazFFFNotIm
	+ ~Global("ImoenRomanceActive","GLOBAL",2) IfValidForPartyDialogue("Imoen2") Global("_bCNChoosesIm3","GLOBAL",0) OR(2) Global("_bImoenMazzyRomance","GLOBAL",1) Global("_bImoenWants3","GLOBAL",0)~ + @308 + _bMazFFFLaterIm
	+ ~Global("ImoenRomanceActive","GLOBAL",2) IfValidForPartyDialogue("Imoen2") Global("_bImoenMazzyRomance","GLOBAL",2) Global("_bImoenWants3","GLOBAL",1)~ + @308 + _bMazFFFYesIm
	+ ~Global("ImoenRomanceActive","GLOBAL",2) IfValidForPartyDialogue("Imoen2") Global("_bImoenMazzyRomance","GLOBAL",2) Global("_bImoenWants3","GLOBAL",2)~ + @308 + _bMazFFFDuhIm
	...
	SAY @313 /*While she is attractive, I do not believe she cares for women in that way.*/
	= @317
	IF ~~ THEN EXIT
	END
...
CHAIN MAZZY25J _bMazFFFVicAgain
...
== VICON25J @321 /*Of course, my tiny paladin. I knew you would not be able to resist now that you have seen my skill. Indeed, I must make sure that <CHARNAME> has not forgotten <PRO_HISHER> lessons in how to pleasure a lover properly.*/
= @322 /*Tell <CHARNAME> we are resting now. I do not wish to wait.*/
DO ~RestParty()~
EXIT
	
//Re-writing this whole block. Use @326 through @372
CHAIN MAZZY25J _bMazBJTale
...
CHAIN MAZZY25J _bMazBJTale4
	@336 /*A wise choice. Let us be on our way.*/
EXIT

CHAIN MAZZY25J _bMazBJTale5
	...
	= @340 /*A couple of the women and I became good friends and at my request they showed me techniques with some of their customers.*/
...
CHAIN MAZZY25J _bMazBJTale2nd1
...
CHAIN MAZZY25J _bMazBJTale2nd2
...
APPEND MAZZY25J IF ~~ THEN _bFirstMazzyPalaSexTalk1
...
CHAIN MAZZY25J _bFirstMazzyPalaSexTalk4
...
== MAZZY25J IF ~Gender(Player1,MALE) Global("_bMazzyRomance","GLOBAL",2)~ THEN @372000 /*I did eventually manage success with my mouth and to tell the truth, my love, after them you are hardly a challenge.*/
== MAZZY25J @372001 /*Their fighting skills improved tremendously as well and eventually they felt it was time to see the world. They travelled to the south, hoping to take jobs as mercenaries in a nearby kingdom that hired their kind.*/
...
APPEND MAZZY25J IF ~~ THEN _bMazMaleChoices
	...
	SAY @437 /**sigh * Next time we are together, I will show you exactly where. The only required skill is your ability to follow directions.*/
	IF ~~ THEN + _bMazMalePart20
	END
...
CHAIN MAZZY25J _bMazzyPalaSexTalk
...
APPEND MAZZY25J IF ~~ THEN _bMazzyPalaSexTalk1
	SAY @520 /*He didn't. I broke off our engagement and went into service at the temple of Arvoreen.*/
...
CHAIN MAZZY25J _bMazzyPalaSexTalk4
@523 /*He is married now, with a beautiful wife and three intelligent and adorable children. They are happy and successful and are loved and respected by everyone who knows them.*/
= @524 /*I still see him from time to time and think, “That could have been me.” But it was not the life I wanted.*/
= @525 /*I think I am done with this topic today. Let us move on.*/
EXIT

CHAIN MAZZY25J _bMazzyBedCount
@527 /*This seems like a rather prying question, <CHARNAME>.*/
DO ~SetGlobal("_bMazBedCount","GLOBAL",1)~
== MAZZY25J IF ~OR(2) Gender(Player1,FEMALE) !Race(Player1,HALFLING)~ THEN @528 /*However, I have been romantically involved with three halfling men.*/
== MAZZY25J IF ~Gender(Player1,MALE) Race(Player1,HALFLING)~ THEN @529 /*However, before you I was romantically involved with three other halfling men.*/
...
CHAIN MAZZY25J _bMBC1
@537 /*One. And this conversation is over.*/
EXIT

CHAIN MAZZY25J _bMBC2
...
CHAIN MAZZY25J _bMBC5
@542000 /*How many non-halfling men? I shall have to think...*/
== MAZZY25J IF ~Global("_bMazzyHalfOgres","GLOBAL",0)~ THEN @542 /*Other than my pair of half-ogres? None, none at all.*/
	DO ~SetGlobal("_bMazzyHalfOgres","GLOBAL",1)~
== MAZZY25J IF ~Global("_bMazzyHalfOgres","GLOBAL",2)~ THEN @542 /*Other than my pair of half-ogres? None, none at all.*/
= @543 /*Let's move on.*/
EXIT

CHAIN MAZZY25J _bMBC6
@544 /*I did, didn't I?*/
= @543 /*Let's move on.*/
EXIT


CHAIN MAZZY25J _bMazzyHeight
@546 /*What? Why?*/
...
END
	+ ~RandomNum(3,1)~ + @586 /*Dragon Chess.*/ EXTERN MAZZY25J _bMDC1
	+ ~RandomNum(3,2)~ + @586 EXTERN MAZZY25J _bMDC2
	+ ~RandomNum(3,3)~ + @586 EXTERN MAZZY25J _bMDC3
	+ ~RandomNum(3,1)~ + @587 /*A game of dice.*/ EXTERN MAZZY25J _bMD1
	+ ~RandomNum(3,2)~ + @587 EXTERN MAZZY25J _bMD2
	+ ~RandomNum(3,3)~ + @587 EXTERN MAZZY25J _bMD3
	+ ~RandomNum(3,1)~ + @588 /*I Spy. We can play while traveling.*/ EXTERN MAZZY25J _bMIS1
	+ ~RandomNum(3,2)~ + @588 EXTERN MAZZY25J _bMIS2
	+ ~RandomNum(3,3)~ + @588 EXTERN MAZZY25J _bMIS3
	+ ~RandomNum(3,1)~ + @589 /*Cards.*/ EXTERN MAZZY25J _bMC1
	+ ~RandomNum(3,2)~ + @589 EXTERN MAZZY25J _bMC2
	+ ~RandomNum(3,3)~ + @589 EXTERN MAZZY25J _bMC3
	
CHAIN MAZZY25J _bMDC1
...
CHAIN MAZZY25J _bMISQUIT1
@685 /**sigh* I do not have time for this nonsense. I concede the victory. May we continue now?*/
DO ~AddXPObject("Mazzy",1000) AddXPObject(Player1,1000)~
EXIT

CHAIN MAZZY25J _bMISQUIT2 
@686 /*Then I suppose you have won this round. Next time you will lose.*/
DO ~AddXPObject("Mazzy",1000) AddXPObject(Player1,1000)~
EXIT

CHAIN MAZZY25J _bMIS7
@687 /*Something red? There are many options here.*/
== MAZZY25J IF ~InParty("Edwin")~ THEN @688 /*Is it the wizard, Edwin? He takes great pride in those red robes.*/
== MAZZY25J IF ~!InParty("Edwin")~ THEN @689 /*Are you thinking about the Red Wizards? If one is near, we should attack.*/
...
== MAZZY25J @721 /*And there's the last pair. I've beaten you. I admit, that was diverting. But we should keep moving now.*/
DO ~AdvanceTime(TWENTY_MINUTES) AddXPObject("Mazzy",1500) AddXPObject(Player1,500)~
EXIT

CHAIN MAZZY25J _bMCGF6
...
== MAZZY25J @724 /*I can't believe it. I almost never lose Go Fish. You owe me a rematch later on.*/
EXIT
	
CHAIN MAZZY25J _bMCGF7
...
== MAZZY25J @727 /*Well, I suppose that was quick, though I was not expecting to win that easily. We should do this again another time.*/
EXIT

CHAIN MAZZY25J _bMCGF8
...
== MAZZY25J @730 /*Yes, very fun. This game is mine. We may play again in the future, but we should not take too much time. There are many souls in need of help.*/
EXIT
	
CHAIN MAZZY25J _bMCGF9
...
DO ~AdvanceTime(TEN_MINUTES) AddXPObject("Mazzy",1500) AddXPObject(Player1,500)~
== MAZZY25J @733 /*A good game, but you're dealing with a master. Now that I've won, we should be going anyway.*/
EXIT

CHAIN MAZZY25J _bMCGF10
...
== MAZZY25J @736 /*You've beaten me. That's impossible. I'll get you on the rematch, wait and see.*/
EXIT

CHAIN MAZZY25J _bMCGF11
...
== MAZZY25J @739 /*And the game is mine, just as expected. Let us continue travelling.*/
EXIT

CHAIN MAZZY25J _bMCGF12
...
== MAZZY25J @742 /*How? I was doing so well... I do not like games of luck. We had best be moving on.*/
EXIT
	

CHAIN MAZZY25J _bMC2
...
APPEND PLAYER1 IF ~~ THEN _bMCPKEND1
	...
	IF ~~ THEN DO ~AddXPObject("Mazzy",1000) AddXPObject(Player1,1000)~ EXTERN MAZZY25J _bMCPKEND
	END
	
	IF ~~ THEN _bMCPKEND2
	SAY @765 /**One hour later, Mazzy has destroyed you. If you were gambling for money, she would be much richer now.**/
	IF ~~ THEN DO ~AddXPObject("Mazzy",1500) AddXPObject(Player1,500)~ EXTERN MAZZY25J _bMCPKEND
	END
	...
	IF ~~ THEN DO ~AddXPObject("Mazzy",500) AddXPObject(Player1,1500)~ EXTERN MAZZY25J _bMCPKEND
	END
END

CHAIN MAZZY25J _bMCPKEND
@767 /*That was fun, <CHARNAME>. Perhaps you were right about relaxing. But we should continue now.*/
DO ~AdvanceTime(ONE_HOUR)~
EXIT


CHAIN MAZZY25J _bMC3
...
CHAIN MAZZY25J _bMazzyViolent1
...
CHAIN MAZZY25J _bMazzyTruesword
...
CHAIN MAZZY25J _bMazzyTruesword1
@812 /*That, <CHARNAME>, is a story for another time.*/
EXIT

CHAIN MAZZY25J _bMazzyTruesword2
...
CHAIN MAZZY25J _bMazzyTruesword3
@814 /*It was certainly an adjustment. But even I must rest sometimes.*/
EXIT

CHAIN MAZZY25J _bMazzyTruesword4
@815 /*It hasn't always been the easiest road, but I am glad as well.*/
EXIT


CHAIN MAZZY25J _bMazzyWraithTalks
@817 /*Because I was young and foolish... is that not always the reason?*/
DO ~SetGlobal("_bPostWraithQuestions","GLOBAL",2)~
= @818 /*There was talk of an invading army and several lords banded together to create their own army in defence. I was young and idealistic and wanted to protect my homeland against the evil invaders.*/
= @819 /*There were many hardened veterans, but many young faces as well, though I was one of the only halflings. It was scary, but also exhilarating to be part of something so grand.*/
= @820 /*A couple of older women who had fought many battles took me under their wing. We sparred daily and I learned many tricks of combat. They also showed me how to safely deflect the advances of the other soldiers and how to manage all the mundane logistics of being on the march.*/
= @821 /*Whatever discipline and glory that army had lasted only until the first city we came to. They were not even our enemy; in fact, they were happy to trade with us provided we camped outside their walls.*/
= @822 /*Their gates were open so we soldiers came and went freely, spending our coin on whatever we could.*/
= @823 /*But there was some affront and suddenly word spread through the camp that there was fighting in the city and we were all supposed to rush in and help.*/
= @824 /*The city guards tried to close the gates, but there were so many of our soldiers already inside that they were overwhelmed.*/
= @825 /*And that was that.*/
EXIT


CHAIN MAZZY25J _bMazzyWraithTalks2
@827 /*What always happens in war. I was a young soldier who stupidly thought we were fighting for honour and glory.*/
DO ~SetGlobal("_bPostWraithQuestions","GLOBAL",3)~
= @828 /*But there was no honour in what happened. The army dissolved in chaos and violence as soon as it was inside the walls.*/
= @829 /*Have you ever witnessed the fall of a city, <CHARNAME>? The bloodlust and the screaming? Our soldiers pillaged, raped, and murdered the townsfolk without mercy.*/
= @830 /*I ran crying until I found the two women who had befriended me during the march.*/
= @831 /*They were in a house torturing an old man to find where he had hidden his valuables, while another soldier raped a girl in the corner.*/
= @832 /*I said what they were doing was wrong and they laughed at me; they did not even pause their actions.*/
= @833 /*I drew my sword and demanded their compliance, and do you know what one said? "Little halfling girls do not belong in war. Now put your knife away before we have to hurt you."*/
END
	++ @834 /*This ends poorly, doesn't it?*/ + _bMazzyWraith2Talks2
	++ @835 /*So you killed them all.*/ + _bMazzyWraith2Talks2
	++ @836 /**sigh* That was a mistake.*/ + _bMazzyWraith2Talks2
	++ @837 /*I'm not sure you've ever been a “little halfling girl.”*/ + _bMazzyWraith2Talks2
	
CHAIN MAZZY25J _bMazzyWraith2Talks2
@838 /*I killed two of them... they were so surprised. The man ran away.*/
= @839 /*The next thing I remember, I was in the woods with the old man and the girl, his granddaughter. I had saved them.*/
= @840 /*We walked for days without pausing... I do not remember where we were going, or if we had a direction at all.*/
= @841 /*I was a deserter and a traitor; I could not return home. We stayed in the wilds, avoiding any other people, just trying to move farther and farther away from the horrors behind us.*/
= @842 /*Somehow, nestled high on a mountain, cut off from all other civilization, I found a temple of Arvoreen.*/
= @843 /*I would stay there for the next year.*/
EXIT


CHAIN MAZZY25J _bMazzyWraithTalks3
@845 /*I suppose I have put it off long enough.*/
DO ~SetGlobal("_bPostWraithQuestions","GLOBAL",4)~
= @846 /*While I was hiding in the temple of Arvoreen, my father received word that the army I had been part had been defeated.*/
= @847 /*Defeated is a rather strong word since it implies there was even a fight. I heard the full story later:*/
= @848 /*While my former comrades were busy sleeping off their days of pillage and rape, the opposing army found them and moved to surround the city. Normally an army spreading their forces so thin would have been risky, but the attackers were in no danger.*/
= @849 /*They bombarded and burned the city until no one was left alive. Everyone who tried to flee was slaughtered. I visited it again later and it was horrible to look at it. No one lives there, even now.*/
= @850 /*My father knew none of that at the time; all he heard was that the army, his daughter's army, was under attack. He took his weapons and armour and left and no one ever heard from him again.*/
= @851 /*I assume he tried to rescue me, but I do not know where he went or how he fell. I do not even know for sure that he is dead, but I believe he is.*/
= @852 /*My mother tried for years to find him magically, but to no avail.*/
= @853 /*And that is all I know. I wish there was more to tell.*/
EXIT


CHAIN MAZZY25J _bMazzyWraithTalks4 
@855 /*I spent a year in the mountain temple of Arvoreen, cut off from news of the world.*/
DO ~SetGlobal("_bPostWraithQuestions","GLOBAL",5)~
= @856 /*One day news arrived that my old army had been destroyed. Had I stayed, I would have been killed along with them.*/
= @857 /*This meant that no one knew I was a traitor; no one knew that I had killed my fellow soldiers to save two townsfolk.*/
= @858 /*So I gathered my belongings and returned home. My mother and sister were overjoyed to see me; they had both given me up for dead.*/
= @859 /*But then they told me the story of my father, how he had left to find me and never returned. And while they never said it, I knew that it was my fault.*/
= @860 /*He was most likely dead, and it was because of me. He had not wanted me to leave; he said that involving ourselves in the wars of humans was a mistake, but I refused to listen.*/
= @861 /*And gradually life returned to normal. I joined the militia, I met my love Korrich, and I spent years living as I thought I should, but I could not find peace. The only peace I had found since leaving for the army was at that temple of Arvoreen.*/
= @862 /*So I left and returned to the temple and finished my training. I broke Korrich's heart, but I knew it was what I had to do. I could not return to the life I had known before the war.*/
END
	++ @863 /*I understand. I cannot even imagine going back to Candlekeep.*/ + _bMazzy1WraithTalks4
	++ @864 /*It's not your fault, you know. You did not kill your father.*/ + _bMazzy2WraithTalks4
	++ @865 /*This explains so much. But you shouldn't let guilt drive you.*/ + _bMazzy3WraithTalks4
	++ @866 /*Maybe when this over, we can discover what happened to your father.*/ + _bMazzy4WraithTalks4
	++ @867 /**say nothing**/ EXIT
	
CHAIN MAZZY25J _bMazzy1WraithTalks4
@868 /*Yes, I thought you would. Our histories are similar and I appreciate your willingness to listen. It has helped, though I'm not sure if I will ever be able to set my burdens down.*/
EXIT

CHAIN MAZZY25J _bMazzy2WraithTalks4
@869 /*Maybe, but he's dead because of me. Nothing you say can change that.*/
EXIT

CHAIN MAZZY25J _bMazzy3WraithTalks4
@870 /*It is not that simple. I cannot simply forget what I have done.*/
= @871 /*There is blood on my hands, <CHARNAME>, the blood of innocents and someone that I loved. I will spend the rest of my life trying to atone.*/
EXIT

CHAIN MAZZY25J _bMazzy4WraithTalks4
@872 /*That is probably a hopeless quest, <CHARNAME>. If my father lived, he would have returned to Trademeet years ago.*/
= @873 /*But I appreciate the offer and if you are truly willing, I would like to make one last attempt to discover how he died.*/
EXIT

CHAIN MAZZY25J _bMazOnlyLikesSexComplaint
...
CHAIN MAZZY25J _bMazOnlyLikesSexComplaint1
...
CHAIN MAZZY25J _bMazOnlyLikesSexComplaint2
...
CHAIN MAZZY25J _bMazOnlyLikesSexComplaint3
...
CHAIN MAZZY25J _bMazOnlyLikesSexComplaint4
	@890 /*Thank you, <CHARNAME>. I do love you... just be patient with me.*/
EXIT

CHAIN MAZZY25J _bMazOnlyLikesSexComplaint5
...
CHAIN MAZZY25J _bMazOnlyLikesSexComplaint6
...
CHAIN MAZZY25J _bMazzyNoLikeRomance
...
CHAIN MAZZY25J _bMazzyNoLikeRomance1
...
CHAIN MAZZY25J _bMazzyNoLikeRomance2
...
CHAIN MAZZY25J _bMazzySpeaksLove1
...
CHAIN MAZZY25J _bMazzySpeaksLove2
...
CHAIN MAZZY25J _bMazzySpeaksLove3
...
CHAIN MAZZY25J _bMazzySpeaksLove6
...
CHAIN MAZZY25J _bMazzySpeaksLove7
...
CHAIN MAZZY25J _bMazzySpeaksLove8
...
CHAIN MAZZY25J _bMazzySpeaksLove9
	@951 /*Yes... about that...*/
...
CHAIN MAZZY25J _bMazzySpeaksLove10a
...
CHAIN MAZZY25J _bMazzySpeaksLove10b
...
CHAIN MAZZY25J _bMazzySpeaksLove11
	@961 /*My lovers? I shall have to think.*/
== MAZZY25J IF ~Global("_bMazzyPastLoversLove","GLOBAL",0)~ THEN @962 /*There was Patrick, of course, the love of my life.*/
...
== MAZZY25J IF ~Global("_bMazzyPastLoversLove","GLOBAL",1)~ THEN @966 /*Before Patrick were my half-ogres, Glounder and Farooq. That love was calmer, and it blossomed during a time of peace and study.*/
	DO ~SetGlobal("_bMazzyHalfOgres","GLOBAL",1)~
...
== MAZZY25J IF ~Global("_bMazzyPastLoversLove","GLOBAL",2)~ THEN @972 /*Before my half-ogres was Korrich, my "thuchiendung".*/
...
== MAZZY25J IF ~Global("_bMazzyPastLoversLove","GLOBAL",3)~ THEN @979 /*I suppose before Korrich there was Perrin, a boy I knew when growing up.*/
	...
	= @987 /*...and I smile.*/
== MAZZY25J IF ~Global("_bMazzyPastLoversLove","GLOBAL",4)~ THEN @988 /*That is it. I have told you about every lover of any importance.*/
...
== MAZZY25J @992 /*And I believe that is all I shall say about that. We can talk more on this topic another day.*/ 
DO ~IncrementGlobal("_bMazzyPastLoversLove","GLOBAL",1)~ 
EXIT

CHAIN MAZZY25J _bMazzySpeaksLove12
...
CHAIN MAZZY25J _bMazzySpeaksLove13
...
CHAIN MAZZY25J _bMazzySpeaksLove14
...
CHAIN MAZZY25J _bMazzySpeaksLove15
...
== MAZZY25J IF ~GlobalGT("PalaCureFound","GLOBAL",2)~ THEN @1012 /*I cannot thank you enough for helping me save her life.*/
== MAZZY25J @1013 /*Her love for me is "caodienvan," since I am the elder. That word implies the emulation of me as a role model rather than protectiveness.*/
	= @1014 /*We should visit her again soon.*/
EXIT

CHAIN MAZZY25J _bMazzySpeaksLove16
...
CHAIN MAZZY25J _bMazzySpeaksLove17
	@1020 /*Of course. How foolish of me.*/
== MAZZY25J IF ~!Global("_bMazzyRomance","GLOBAL",2) !Global("_bMazzyRomance","GLOBAL",1)~ THEN @1021 /*You are my friend, <CHARNAME>, not to mention the one who saved my life.*/
...
== MAZZY25J IF ~Global("_bMazzyRomance","GLOBAL",1)~ THEN @1023 /*A friend who hopes to be something more? That love is reciprocal; I desire the same thing. And that makes it "dedat".*/
== MAZZY25J IF ~Global("_bMazzyRomance","GLOBAL",2)~ THEN @1024 /*I would hope that you consider us more than friends, <CHARNAME>. At the very least we are a romantic couple.*/
== MAZZY25J @1025 /*Thank you for the reminder. Sometimes I think myself alone against the world.*/ 
EXIT

CHAIN MAZZY25J _bMazzySpeaksLove18
...
CHAIN MAZZY25J _bMazzySpeaksLove19
...
CHAIN MAZZY25J _bMazzySpeaksLove20
...
CHAIN MAZZY25J _bMazzySpeaksLove21a
...
CHAIN MAZZY25J _bMazzySpeaksLove21b
...
CHAIN MAZZY25J _bMazzySpeaksLove22
...
CHAIN MAZZY25J _bMazzySpeaksLove23
...
CHAIN MAZZY25J _bMazzySpeaksLove24
...
CHAIN MAZZY25J _bMazzySpeaksLove25
...
CHAIN MAZZY25J _bMazzySpeaksLove26
